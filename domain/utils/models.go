...
func (d *AbstractDomain) SetExternalSuperAdmin(external bool) { d.ExternalSuperAdmin = external }
...
func (d *AbstractDomain) IsSuperCall() bool                   { return d.Super && d.SuperAdmin || d.ExternalSuperAdmin }
