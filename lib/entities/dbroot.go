...
var DBView = TableEntity{
	...
	Columns : []TableColumnEntity{
		...
		TableColumnEntity{ Name: "wrapper_sql_view", Type: "varchar(255)", Null : true, },
		TableColumnEntity{ Name: "skip_wrapper", Type: "boolean", Null : false, },
		TableColumnEntity{ Name: RootID("wrapper"), Type: "integer", ForeignTable : DBSchema.Name, Null : true, },
