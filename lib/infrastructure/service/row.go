...
func (t *TableRowInfo) Get(restriction... string) (tool.Results, error) {
	if t.PermService != nil {
		t.db = ToFilter(t.Table.Name, t.Params, t.db, t.PermService.ColsPartialResults, restriction...)
	} else { t.db = ToFilter(t.Table.Name, t.Params, t.db, "", restriction...) }
...
func (t *TableRowInfo) Create() (tool.Results, error) {
	...
	if t.SpecializedService != nil {
		...
		_, view := t.SpecializedService.ConfigureFilter(t.Table.Name)
		if view != "" { t.db.SQLView = view }
	}
