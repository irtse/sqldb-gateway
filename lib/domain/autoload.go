...
var DBRootViews = []map[string]interface{}{ 
	...
	map[string]interface{} { schserv.NAMEKEY : "my validated requests",
	"is_list" : true,
	"indexable" : true,
	"description" : nil,
	"readonly" : true,
	...
	map[string]interface{} { schserv.NAMEKEY : "my assigned activity",
	"is_list" : true,
	"indexable" : true,
	"description" : nil,
	"readonly" : false,
	...
	map[string]interface{} { schserv.NAMEKEY : "my archived activity",
	"is_list" : true,
	"indexable" : true,
	"description" : nil,
	"readonly" : true,
